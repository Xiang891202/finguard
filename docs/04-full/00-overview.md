📄 更新文件 1：完整版功能規劃書（00-overview.md）
版本：v1.5
所屬：完整版
Phase 數量：20（P1 ~ P19 + P5.5）

1. 完整版目標
將 MVP（個人 / 家庭）升級為多租戶 SaaS，包含：

多租戶隔離

完整插件化（所有 Handler + 管理員 CRUD）
...
自動排程	✅	MVP 手動
人體剖面圖	✅ 互動	MVP 無
引擎版本管理（v1.5）	✅ 5 引擎	MVP 無
LLM Provider（v1.5）	✅ 5 層抽象	MVP 模板
漫畫	✅ 動態	MVP 靜態
精算	✅ 完整	MVP 基礎
自癒	✅ 三級	MVP Level 1
金流	✅	MVP 關閉
醫療費用	✅ 爬蟲	MVP 人工
部署	AWS / GCP	MVP Render
3. 20 個 Phase 總覽（v1.5 更新）
Phase	名稱	依賴 MVP	主要產出	工時
P1	多租戶架構	P1	tenant_id 隔離	5 天
P2	資產類別 + 標的管理	P3	完整 CRUD	6 天
P3	更多 Handler	P3, P5, P6	Bond / Metal / Crypto	6 天
P4	自動排程爬蟲	P7	Celery Beat	4 天
P5	人體剖面圖	P8	SVG 互動	7 天
P5.5	引擎版本管理	P7, P9	5 引擎版本系統	8 天
P6	保險商品爬蟲	P8	Finfo + 官網雙源	8 天
P7	保險缺口分析	P11	每日快照	5 天
P8	保險保單擴充子分類	P8	壽險 / 意外 / 疾病	4 天
P9	LLM Provider + 編輯器	P9	5 層抽象層	10 天
P10	漫畫生成	P10	動態漫畫模板	5 天
P11	保險缺口精算	P11	8 項乘數	7 天
P12	Report Aggregator	P10	合併金融 + 保險	4 天
P13	多語言支援	-	i18n	4 天
P14	效能優化	-	快取、索引	5 天
P15	指揮中心	P10	三級修復 + 引擎管理	9 天
P16	資料匯出 / 匯入	-	CSV / JSON	5 天
P17	API 開放	-	API Key	5 天
P18	金流模組	-	Java + Stripe	12 天
P19	醫療費用爬蟲	P11	衛福部資料	6 天
總計	-	-	-	121 天（v1.4：114 天）
v1.5 工時變化：+7 天（新增 P5.5 + P9 擴充 + P15 擴充）
...
P5.5 引擎版本管理必須在 P6-P15 之前完成，因為後續所有引擎都需要版本管理

P9 LLM Provider依賴 P5.5 的編輯器框架
...
Redis Pub/Sub 快取失效（v1.5）

保險商品雙源比對與生命週期管理

每日保險缺口快照

LLM Provider 抽象層（5 層）（v1.5）
...
Full P5.5（引擎版本管理）★ 新增
    ↓
Full P9（Provider 抽象層）★ 擴充
    ↓
Full P15（指揮中心整合引擎管理）★ 擴充
8. 版本紀錄
版本	日期	變更
v1.0	2026-09-20	初版
v1.1	2026-09-20	新增管理員區隔
v1.2	2026-09-20	新增金流規格
v1.3	2026-09-20	修正零遷移、PostgreSQL
v1.4	2026-09-21	新增健康檔案、醫療費用
v1.5	2026-09-22	新增 P5.5、擴充 P9、擴充 P15、Phase 19→20
文件結束

📄 新增文件 2：Full Phase 5.5 引擎版本管理系統
版本：v1.5
所屬：完整版
依賴 Phase：
